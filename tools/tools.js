...
import { registerMarketPoll, registerMarketPollScheduler } from "./marketpoll.js";
...
const TOOL_MODULES = [
  ...
  { id: "marketpoll", register: registerMarketPoll, registerScheduler: registerMarketPollScheduler },
];
